                ...
                <div class="row">
                            ...
                            <div class="product-img-large">
                                <div class="img-large-slider common-slider"
                                    ...
                                    <div class="img-large-wrapper">
                                        <a href="{{ URL::asset('/images/shirt0.jpg') }}" data-fancybox="gallery">
                                            <img src="{{ URL::asset('/images/shirt0.jpg') }}" alt="img">
                                        </a>
                                    </div>
                                    <div class="img-large-wrapper">
                                        <a href="{{ URL::asset('/images/shirt0.jpg') }}" data-fancybox="gallery">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-details ps-lg-4">
                            ...
                            <h2 class="product-title mb-3">{{$product_detail->name}}</h2>
                            ...
                            <div class="product-price-wrapper mb-4">
                                <span class="product-price regular-price">{{$product_detail->price}}</span>
                            </div>
